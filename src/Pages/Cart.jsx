...
import cart_empty_img from "../assets/img/empty-cart.png"
...
const Cart = () => {
    ...
    const onClearCart = () => {
        if (window.confirm('Do you want delete all pizzas from cart?'))
            dispatch(clearCart())
    }
    const onRemoveGroup = (id) => {
        if (window.confirm('Do you want delete this pizzas from cart?'))
    ...
    const onClickOrder = () => {
        console.log("Twoje zamówienie", items)
    }
                        ...
                        ? <div className="cart">
                            <div className="cart__top">
                                ...
                                <div className="cart__clear">
                                    ...
                                    <span onClick={onClearCart}>Usuń wszystko</span>
                                </div>
                            </div>
                            <div className="content__items">
                                {pizzasGroup && pizzasGroup.map((item) => (
                                    <CartItem name={item.name}
                                              ...
                                              key={item.name + item.type + item.size + item.id}
                                    />
                                ))}
                            ...
                            <div className="cart__bottom">
                                <div className="cart__bottom-details">
                                    <span> Razem : <b>{totalCount} szt.</b> </span>
                                ...
                                <div className="cart__bottom-buttons">
                                    ...
                                    <Button paybtn onClick={onClickOrder}>
