...
const SortPopup = React.memo(({activeSortBy, onSetSortBy, items}) => {
                ...
                <ul>
                    {items && items.map((item, index) => {
                        return <li onClick={() => onSelectItem(index)}
                                   ...
                                   className={item.type === activeSortBy ? 'active' : ''}
                        >{item.name}</li>
                    })}
                </ul>
            </div>}
